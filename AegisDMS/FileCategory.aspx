<%@ Page Title="File Category" Language="C#" MasterPageFile="~/MainLayout.Master" AutoEventWireup="true" CodeBehind="FileCategory.aspx.cs" Inherits="AegisDMS.FileCategory" %>
            ...
            <div class="row-fluid">
                ...
                <div class="span6">
                    <div class="widget-box">
                        ...
                        <div class="widget-content">
                            <div class="form-horizontal">
                                <asp:GridView ID="gvFileCategory" runat="server" class="table table-bordered table-striped"
                                    AutoGenerateColumns="false" AllowPaging="true" PageSize="10"
                                    OnPageIndexChanging="gvFileCategory_PageIndexChanging" OnRowCommand="gvFileCategory_RowCommand">
                                    <Columns>
                                        <asp:TemplateField>
                                            <HeaderTemplate>
                                                SN.
                                        ...
                                        <asp:TemplateField HeaderText="File Category Name">
                                            <ItemTemplate>
                                                <%# Eval("Name") %>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:ImageButton ID="ImgEdit" runat="server" CausesValidation="false" CommandName="E"
                                                    CommandArgument='<%# Eval("FileCategoryId") %>' ImageUrl="~/img/custom/edit-button.png"
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:ImageButton ID="ImgDelete" runat="server" CausesValidation="false" CommandName="D"
                                                    CommandArgument='<%# Eval("FileCategoryId") %>' ImageUrl="~/img/custom/delete-button.png"
