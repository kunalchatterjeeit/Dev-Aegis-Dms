<%@ Page Title="File Type" Language="C#" MasterPageFile="~/MainLayout.Master" AutoEventWireup="true" CodeBehind="FileType.aspx.cs" Inherits="AegisDMS.FileType" %>
            ...
            <div class="row-fluid">
                ...
                <div class="span6">
                    <div class="widget-box">
                        ...
                        <div class="widget-content">
                            <div class="form-horizontal">
                                <asp:GridView ID="gvFileType" runat="server" class="table table-bordered table-striped"
                                    AutoGenerateColumns="false" AllowPaging="true" PageSize="10" OnPageIndexChanging="gvFileType_PageIndexChanging" OnRowCommand="gvFileType_RowCommand">
                                    <Columns>
                                        <asp:TemplateField>
                                            <HeaderTemplate>
                                                SN.
                                        ...
                                        <asp:TemplateField HeaderText="File Type Name">
                                            <ItemTemplate>
                                                <%# Eval("Name") %>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:ImageButton ID="ImgEdit" runat="server" CausesValidation="false" CommandName="E"
                                                    CommandArgument='<%# Eval("FileTypeId") %>' ImageUrl="~/img/custom/edit-button.png"
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:ImageButton ID="ImgDelete" runat="server" CausesValidation="false" CommandName="D"
                                                    CommandArgument='<%# Eval("FileTypeId") %>' ImageUrl="~/img/custom/delete-button.png"
