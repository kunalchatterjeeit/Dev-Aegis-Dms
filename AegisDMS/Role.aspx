<%@ Page Title="Role" Language="C#" MasterPageFile="~/MainLayout.Master" AutoEventWireup="true" CodeBehind="Role.aspx.cs" Inherits="AegisDMS.Role" %>
                        ...
                        <div class="widget-content">
                            <div class="form-horizontal">
                                <asp:GridView ID="gvRole" runat="server" class="table table-bordered table-striped"
                                    ...
                                    OnPageIndexChanging="gvRole_PageIndexChanging" OnRowCommand="gvRole_RowCommand">
                                    <Columns>
                                        <asp:TemplateField>
                                            <HeaderTemplate>
                                                SN.
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:ImageButton ID="ImgEdit" runat="server" CausesValidation="false" CommandName="E"
                                                    CommandArgument='<%# Eval("RoleId") %>' ImageUrl="~/img/custom/edit-button.png"
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:ImageButton ID="ImgDelete" runat="server" CausesValidation="false" CommandName="D"
                                                    CommandArgument='<%# Eval("RoleId") %>' ImageUrl="~/img/custom/delete-button.png"
